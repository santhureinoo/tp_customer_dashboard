...
const CustomerEdit = ({ openCustomerEdit, setOpenCustomerEdit }: Props) => {
    ...
    return (
        <div className={`shadow-lg overflow-auto top-0 space-y-12 px-6 pt-12 bottom-0 right-0 fixed w-full md:w-[46vw] h-full bg-white ease-in-out z-50 duration-300 ${openCustomerEdit ? "translate-x-0 " : "translate-x-full"}`}>
